...
void Security::Update(float dt) {
  ...
  this->bodyColliderBox->SetOffset(
      {float(this->orientation ? RIGHT - 30 : 30), float(0)});
}

void Security::ResetSpeed() { this->speed = 115; }
